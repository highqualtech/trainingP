...
@endif
    <form method="POST" action="{{ route('courseslides.update', ['id' => $course->courseid,'slideid' => $courseslide->courseslideid]) }}" enctype="multipart/form-data" id="courseslide">
        @csrf
        @method('PATCH')
        <table class="table">
            <tr>
                <td>Internal Title:</td>
                <td><input type="text" name="slide_title" class="form-control prevent-leave" value="{{ $courseslide->slide_title }}"></td>
            </tr>
            <tr>
                ...
                <td><input type="file" name="audiodescription" class="form-control prevent-leave"></td>
            </tr>
            <tr>
                <td>Slide Type: </td>
                <td><select name="slide_type" class="form-control prevent-leave" id="slide_type">
    ...
    <div id="slidehtml" @if(($courseslide->slide_type!='1')&&($courseslide->slide_type!='5')) style="display:none" @endif>
        ...
        <textarea name="slidehtml" class="ckeditor prevent-leave" id="editor" style="height:800px;">{{ $courseslide->slidehtml }}</textarea>
    </div>
    ...
    <div id="slidequestion" @if(($courseslide->slide_type!='3')&&($courseslide->slide_type!='5')&&($courseslide->slide_type!='6')) style="display:none" @endif>
        ...
        <input type="radio" name="slidequestiontype" value="4" class="questiontype" @if($courseslide->slide_questiontype=='4') checked @endif> Non-test question - participant enters text answer - logged by system,  not marked<br>
        ...
        <table class="table table-striped">
            ...
            <tr class="textscore" @if($courseslide->slide_questiontype!='5') style="display:none" @endif>
                <td>Marking Score</td>
                <td><select name="slide_points prevent-leave" class="form-control">
            ...
            <tr class="multi-choice" @if(($courseslide->slide_questiontype=='4')||($courseslide->slide_questiontype=='5')) style="display:none" @endif>
                <td>Answer 1:</td>
                <td><input type="text" name="answer1" value="{{ $courseslide->answertext1 }}" class="form-control prevent-leave"></td>
                <td><input type="checkbox" name="correctanswer[]" value="1" @if(in_array('1', $courseslide->correct_answer)) checked @endif></td>
            </tr>
            <tr class="multi-choice" @if(($courseslide->slide_questiontype=='4')||($courseslide->slide_questiontype=='5')) style="display:none" @endif>
                <td>Answer 2:</td>
                <td><input type="text" name="answer2" value="{{ $courseslide->answertext2 }}" class="form-control prevent-leave"></td>
                <td><input type="checkbox" name="correctanswer[]" value="2"  @if(in_array('2', $courseslide->correct_answer)) checked @endif></td>
            </tr>
            <tr class="multi-choice" @if(($courseslide->slide_questiontype=='4')||($courseslide->slide_questiontype=='5')) style="display:none" @endif>
                <td>Answer 3:</td>
                <td><input type="text" name="answer3" value="{{ $courseslide->answertext3 }}" class="form-control prevent-leave"></td>
                <td><input type="checkbox" name="correctanswer[]" value="3"  @if(in_array('3', $courseslide->correct_answer)) checked @endif></td>
            </tr>
            <tr class="multi-choice" @if(($courseslide->slide_questiontype=='4')||($courseslide->slide_questiontype=='5')) style="display:none" @endif>
                <td>Answer 4:</td>
                <td><input type="text" name="answer4" value="{{ $courseslide->answertext4 }}" class="form-control prevent-leave"></td>
                <td><input type="checkbox" name="correctanswer[]" value="4"  @if(in_array('4', $courseslide->correct_answer)) checked @endif></td>
            </tr>
            <tr class="multi-choice" @if(($courseslide->slide_questiontype=='4')||($courseslide->slide_questiontype=='5')) style="display:none" @endif>
                <td>Answer 5:</td>
                <td><input type="text" name="answer5" value="{{ $courseslide->answertext5 }}" class="form-control prevent-leave"></td>
                <td><input type="checkbox" name="correctanswer[]" value="5"  @if(in_array('5', $courseslide->correct_answer)) checked @endif></td>
            </tr>
            <tr class="multi-choice" @if(($courseslide->slide_questiontype=='4')||($courseslide->slide_questiontype=='5')) style="display:none" @endif>
                <td>Answer 6:</td>
                <td><input type="text" name="answer6" value="{{ $courseslide->answertext6 }}" class="form-control prevent-leave"></td>
                <td><input type="checkbox" name="correctanswer[]" value="6"  @if(in_array('6', $courseslide->correct_answer)) checked @endif></td>
            </tr>
        </table>
    </div>
    <div id="slideconfirmation" @if($courseslide->slide_type!='4') style="display:none" @endif>
        <textarea name="slidehtml2" class="ckeditor prevent-leave" id="editor2" style="height:800px;">{{ $courseslide->slidehtml }}</textarea><br><br>
        Checkbox text:<br>
        <textarea name="confirmationtext" class="form-control prevent-leave">{{ $courseslide->confirmation_text }}</textarea><br><br>
    </div>
        <input type="submit" name="submit" value="Save Slide and Close" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submitremain" value="Save Slide and Remain" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submitsave" value="Save and New Slide" class="btn btn-success">
        <a href="/courseslidepreview/{{ $course->courseid }}/{{ $courseslide->courseslideid }}" class="btn btn-info float-end" target="_blank">Preview Slide</a>
    </form>
@stop
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        // Get all elements with the class 'prevent-leave'
        const textboxes = document.getElementsByClassName('prevent-leave');
                ...
                image: {
                    toolbar: ['imageTextAlternative','imageStyle:alignBlockLeft','imageStyle:alignBlockRight','imageStyle:block','imageStyle:alignLeft','imageStyle:alignRight','imageStyle:alignCenter'],
        ...
        CKEDITOR.ClassicEditor
            ...
            .then( editor => {
                ...
                window.editor.conversion.for('downcast').add(downcastDispatcher => {
                    downcastDispatcher.on('element:img', (evt, data, conversionApi) => {
                        const imgElement = data.item;
            ...
            .catch();
                ...
                // Add event listeners to all elements with the class
                ...
                document.getElementById('courseslide').addEventListener('submit', function() {
                    formSubmitted = true;
                });

                window.addEventListener('beforeunload', function(event) {
                    if (textEntered && !formSubmitted) {
